...
//
//
//Scene::Scene(std::map<std::string, std::shared_ptr<Shader>> ShaderMap)
//	:Layer("Example")
//{
...
//	plane->addComponent<CTransform>(glm::vec3(1.0f, -0.5f, 0.0f), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), -90.0f);
...
//	Light->addComponent<CTransform>(glm::vec3(lightPos), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), 0.0f);
...
//	LightingTest->addComponent<CTransform>(glm::vec3(5.0f, 2.5f, 0.5f), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), 0.0f);
...
//	HDRTest->addComponent<CTransform>(glm::vec3(1.0f, -0.5f, 0.0f), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), 0.0f);
//	HDRTest->addComponent<CModel>(std::make_shared<Model>("models/HDRTest.obj"));
//	
//	auto PBRTest = m_entityManager->addEntity("PBRTest");
//	PBRTest->addComponent<CTransform>(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0f, 1.0f, 1.0f), 0.0f);
